...
{
    [Serializable]
    public class ReqArticlesMessage : GameModeMessage
    {       
        ...
        public ReqArticlesMessage(ushort NewsGlobeID) 
            : base(MessageTypeGameMode.ReqArticles)
        {
            this.NewsGlobeID = NewsGlobeID;          
        }

        public ReqArticlesMessage(byte[] Buffer, int StartIndex = 0) 
