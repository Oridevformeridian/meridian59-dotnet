...
{
    public class SectorMoveMessage : GameModeMessage
    {       
        ...
        public override int ByteLength
        {
            get
            {
                return base.ByteLength + SectorMove.ByteLength;
            }
        }
        ...
        public SectorMove SectorMove { get; set; }
        ...
        public SectorMoveMessage(byte[] Buffer, int StartIndex = 0) 
