...
{
    [Serializable]
    public class RemoveEnchantmentMessage : GameModeMessage
    {        
        ...
        public RemoveEnchantmentMessage(BuffType BuffType, uint ID) 
            : base(MessageTypeGameMode.RemoveEnchantment)
        {         
            this.BuffType = BuffType;
            this.ID = ID;          
        }

        public RemoveEnchantmentMessage(byte[] Buffer, int StartIndex = 0) 
