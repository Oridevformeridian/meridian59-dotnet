...
namespace Meridian59.Protocol.GameMessages
{
    ...
    /// </summary>
    [Serializable]
    public class CounterOfferedMessage : GameModeMessage
    {        
        ...
        public override int ByteLength
        {
            get
            {
                ...
                foreach (ObjectBase obj in OfferedItems)
                    len += obj.ByteLength;
        ...
        public ObjectBase[] OfferedItems { get; set; }

        public CounterOfferedMessage(ObjectBase[] OfferedItems)
            : base(MessageTypeGameMode.CounterOffered)
        {           
            this.OfferedItems = OfferedItems;           
        }

        public CounterOfferedMessage(byte[] Buffer, int StartIndex = 0) 
