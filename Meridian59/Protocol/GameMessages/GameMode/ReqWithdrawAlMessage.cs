...
namespace Meridian59.Protocol.GameMessages
{
    ...
    /// </summary>
    [Serializable]
    public class ReqWithdrawAlMessage : GameModeMessage
    {        
        ...
        public ReqWithdrawAlMessage(uint ID)
            : base(MessageTypeGameMode.ReqWithdrawAl)
        {
            this.ID = ID;
        }

        public ReqWithdrawAlMessage(byte[] Buffer, int StartIndex = 0) 
