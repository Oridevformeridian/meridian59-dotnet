...
{
    [Serializable]
    public class ActionMessage : GameModeMessage
    {       
        ...
        public override int ReadFrom(byte[] Buffer, int StartIndex = 0)
        {
            ...
            Action = (ActionType)Buffer[cursor];
            cursor++;
        ...
        public ActionMessage(ActionType Action) 
            : base(MessageTypeGameMode.Action)
        {
            this.Action = Action;
        }

        public ActionMessage(byte[] Buffer, int StartIndex = 0) 
