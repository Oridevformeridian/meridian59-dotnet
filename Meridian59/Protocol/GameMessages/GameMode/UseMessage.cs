...
namespace Meridian59.Protocol.GameMessages
{
    ...
    /// </summary>
    [Serializable]
    public class UseMessage : GameModeMessage
    {       
        ...
        public override int ByteLength
        {
            get
            {
                return base.ByteLength + NewEquippedItem.ByteLength;
            }
        }
        ...
        public override int WriteTo(byte[] Buffer, int StartIndex = 0)
        {
            ...
            cursor += NewEquippedItem.WriteTo(Buffer, cursor);
        ...
        public ObjectID NewEquippedItem { get; set; }
        ...
        public UseMessage(byte[] Buffer, int StartIndex = 0) 
