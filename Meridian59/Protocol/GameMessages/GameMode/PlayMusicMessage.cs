...
{
    public class PlayMusicMessage : GameModeMessage
    {        
        ...
        public PlayMusic PlayInfo { get; set; }

        public PlayMusicMessage(uint ResourceID) 
            : base(MessageTypeGameMode.PlayMusic)
        {
            this.PlayInfo = new PlayMusic(ResourceID);
        }

        public PlayMusicMessage(byte[] Buffer, int StartIndex = 0) 
