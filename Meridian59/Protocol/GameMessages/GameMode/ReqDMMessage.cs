...
{
    [Serializable]
    public class ReqDMMessage : GameModeMessage
    {      
        ...
        public override int ReadFrom(byte[] Buffer, int StartIndex = 0)
        {
            ...
            CommandType = (DMCommandType)Buffer[cursor];
            cursor++;
        ...
        public DMCommandType CommandType { get; set; }
        public string Message { get; set; }

        public ReqDMMessage(DMCommandType CommandType, string Message) 
            : base(MessageTypeGameMode.ReqDM)
        {
            this.CommandType = CommandType;
            this.Message = Message;
        }

        public ReqDMMessage(byte[] Buffer, int StartIndex = 0) 
