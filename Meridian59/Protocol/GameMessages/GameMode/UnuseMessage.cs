...
namespace Meridian59.Protocol.GameMessages
{
    ...
    /// </summary>
    public class UnuseMessage : GameModeMessage
    {        
        ...
        public UnuseMessage(ObjectID ID) 
            : base(MessageTypeGameMode.Unuse)
        {
            this.ID = ID;           
        }

        public UnuseMessage(byte[] Buffer, int StartIndex = 0) 
