...
{
    public class ChangeTextureMessage : GameModeMessage
    {       
        ...
        public override int ByteLength
        {
            get
            {
                return base.ByteLength + TextureChangeInfo.ByteLength;
            }
        }
        ...
        public TextureChangeInfo TextureChangeInfo { get; set; }
        ...
        public ChangeTextureMessage(byte[] Buffer, int StartIndex = 0) 
