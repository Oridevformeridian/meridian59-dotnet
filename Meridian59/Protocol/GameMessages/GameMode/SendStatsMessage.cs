...
{
    [Serializable]
    public class SendStatsMessage : GameModeMessage
    {       
        ...
        public override int WriteTo(byte[] Buffer, int StartIndex = 0)
        {
            ...
            Buffer[cursor] = (byte)AvatarInfoListType;
            cursor++;
        ...
        public override int ReadFrom(byte[] Buffer, int StartIndex = 0)
        {
            ...
            AvatarInfoListType = (StatGroup)Buffer[cursor];
            cursor++;
        ...
        public StatGroup AvatarInfoListType { get; set; }
