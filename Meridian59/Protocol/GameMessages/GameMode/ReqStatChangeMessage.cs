...
namespace Meridian59.Protocol.GameMessages
{
    ...
    /// </summary>
    [Serializable]
    public class ReqStatChangeMessage : GameModeMessage
    {        
        ...
        public ReqStatChangeMessage(StatChangeInfo StatChangeInfo)
            : base(MessageTypeGameMode.ReqStatChange)
        {
            this.StatChangeInfo = StatChangeInfo;          
        }

        public ReqStatChangeMessage(byte[] Buffer, int StartIndex = 0) 
