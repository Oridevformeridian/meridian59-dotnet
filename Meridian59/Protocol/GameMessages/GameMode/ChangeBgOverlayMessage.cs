...
namespace Meridian59.Protocol.GameMessages
{
    ...
    /// </summary>
    [Serializable]
    public class ChangeBgOverlayMessage : GameModeMessage
    {        
        ...
        public ChangeBgOverlayMessage(byte[] Buffer, int StartIndex = 0) 
            : base (Buffer, StartIndex) { }

        public unsafe ChangeBgOverlayMessage(ref byte* Buffer)
            : base(ref Buffer) { }  
    }
}
